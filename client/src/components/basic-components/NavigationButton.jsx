    ...
    return (
        <div className="flex items-center gap-2">
            ...
            <button
                ...
                className="cursor-pointer bg-zinc-900 relative inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium transition-colors hover:bg-[#F5F5F5] hover:text-[#06B6D4] h-9 px-3"
            >
            ...
            <button
                ...
                className="cursor-pointer bg-zinc-900 relative inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium transition-colors hover:bg-[#F5F5F5] hover:text-[#60A5FA] h-9 px-3"
            >
            ...
            <button
                ...
                className="cursor-pointer bg-zinc-900 relative inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium transition-colors hover:bg-[#F5F5F5] hover:text-[#FACC14] h-9 px-3"
            >
            ...
            <button
                ...
                className="cursor-pointer bg-zinc-900 relative inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium transition-colors hover:bg-[#F5F5F5] hover:text-[#FB923C] h-9 px-3"
            >
